  ...
  def check_employee
    unless @employee
      ...
      if @employee.check_balance?(@order_amount)
        render json: {success: "valid", emp_id: @employee.employee_id, first_name: @employee.first_name, father_name: @employee.father_name, remaining: @employee.remaining}, status: 200
      else
